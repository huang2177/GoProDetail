...
public class RoundImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        shapeType = 2;
        borderWidth = 2;
        borderColor = ContextCompat.getColor(context, R.color.colorWhite);
        //tagDrawable = ContextCompat.getDrawable(context, R.drawable.ic_certified);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap tagBitmap = getBitmapFromDrawable(tagDrawable);

        drawDrawable(canvas, bitmap, tagBitmap);
        drawBorder(canvas);
    }
    ...
    private void drawDrawable(Canvas canvas, Bitmap bitmap, Bitmap tag) {
        // 画笔
        ...
        //画标签
//        if (shapeType == 2 && tagEnable) {
//            Rect rect = new Rect(1, 1, tag.getWidth() - 1, tag.getHeight() - 1);
//            canvas.drawBitmap(tag, rect, rect, paint);
//        }
