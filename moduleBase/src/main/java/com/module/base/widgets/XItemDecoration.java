...
public class XItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public XItemDecoration(Context context, int dividerHight, int dividerColor) {
        this(context);
     ...
     */
    public XItemDecoration(Context context, int dividerHight, Drawable dividerDrawable) {
        this(context);
        mDividerHight = dividerHight;
