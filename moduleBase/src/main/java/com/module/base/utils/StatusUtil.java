...
public class StatusUtil {
     ...
     */
    private static void processFlyMe(boolean isLightStatusBar, Window window) {
     ...
     */
    private static void processMIUI(boolean lightStatusBar, Window window) {
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        setStatusTextColor(useDart,activity.getWindow());
    }
    /**
     * 设置状态栏文字色值为深色调
     *
     ...
     * @param window
     */
    public static void setStatusTextColor(boolean useDart, Window window) {
        if (isFlyme()) {
            processFlyMe(useDart, window);
        } else if (isMIUI()) {
            processMIUI(useDart, window);
        } else {
            if (useDart) {
